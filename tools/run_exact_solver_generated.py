#!/usr/bin/env python3
"""
Run exact_solver algorithm over GENERATED graphs only with a 3-stage timeout strategy.
...
4. Record all results (including final timeouts) to results/exact_solver_generated.csv.
"""
import csv
import subprocess
import sys
...
OUTPUT_CSV = RESULTS_DIR / "exact_solver_generated.csv"
TMP_RESULT = RESULTS_DIR / "tmp_exact_run_gen.csv"
